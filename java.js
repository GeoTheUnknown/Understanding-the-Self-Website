document.addEventListener('DOMContentLoaded', function() {
    ...
    const hiddenChapters = [
        { id: 'chapter-4', title: 'Psychological Perpective of The Self', outcomes: 'From this chapter, students aim to understand the psychological perspective of the self, including key concepts and theories proposed by notable psychologists such as William James and Carl Rogers. They will explore how the self is viewed from both cognitive and affective perspectives and the distinctions between the "I-self" and "me-self." ',  essentials: ' Key essentials for this chapter include grasping William James concepts of the material, social, and spiritual self, as well as Carl Rogers ideas on the perceived self, real self, and ideal self. Additionally, students will understand Freud theory of the unified self versus Gergens notion of multiple selves and how these concepts contribute to our understanding of personal identity and self-perception.', fileLink: 'https://drive.google.com/file/d/1qdeZSWJzfVwWqoVQBjXoo8onrubc4BUN/view?usp=drive_link', postTest: 'https://docs.google.com/forms/d/e/1FAIpQLSc8hypuIMohVeKb2FuzZ5apNe9JQMUjP2cK1HXlulHlOM2S-w/viewform?usp=sf_link', preTest: 'https://docs.google.com/forms/d/e/1FAIpQLSfUZbNk5MnRqaV0FUQaDAI6knITG0u8tVaL5I8Hy6oCT39gcw/viewform?usp=sf_link', activity: 'https://drive.google.com/file/d/1Cp4vxa9z1WBatw0jrMbRoSqmEGictEZ-/view?usp=sharing' ,image: 'chapters/CHAPTER-4.png' },
    ...
    loadMoreButton.addEventListener('click', function(e) {
        ...
        hiddenChapters.forEach(chapter => {
            if (!loadedChapters.find(loadedChapter => loadedChapter.id === chapter.id)) {
                ...
                chapterElement.setAttribute('data-aos-delay', '500');

                chapterElement.innerHTML = `
                
                    <div class="module" id="${chapter.id}">
